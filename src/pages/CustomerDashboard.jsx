...
import { IMAGE_BASE_URL } from "../utils/api"; // ✅ use backend root URL
...
const CustomerDashboard = () => {
  ...
  // ✅ helper: decide image URL
  const getImageUrl = (image) => {
    if (!image) return "/fallback.jpg";
    return image.startsWith("http")
      ? image // already full URL (e.g., Cloudinary)
      : `${IMAGE_BASE_URL}/uploads/${image}`; // local uploads
  };
